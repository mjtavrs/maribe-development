const projects = [
    ...
    {
        id: 12,
        cover: "assets/images/projects/studio-no-mar/studio-no-mar-cover.webp",
        titulo: "studio no mar",
        descricao: {
            pt: "O \"Studio no Mar\" é um flat à beira-mar com vista privilegiada, pensado para aproveitar cada centímetro com funcionalidade e leveza. Elementos naturais trazem textura e conexão com o entorno, enquanto a marcenaria colorida adiciona personalidade ao espaço. A iluminação indireta complementa o ambiente, criando uma atmosfera acolhedora e bem resolvida, mesmo em poucos metros quadrados.",
            en: "\"Studio no Mar\" is a beachfront flat with sweeping ocean views, designed to make the most of every inch with ease and purpose. Natural elements bring texture and a stronger connection to the setting, while colorful millwork adds personality throughout the space. Indirect lighting completes the atmosphere, making it feel warm, inviting, and thoughtfully resolved, even within a compact footprint.",
            es: "\"Studio no Mar\" es un flat frente al mar, con una vista privilegiada, diseñado para aprovechar cada centímetro con funcionalidad y ligereza. Los elementos naturales aportan textura y una conexión más cercana con el entorno, mientras que la carpintería colorida suma personalidad al espacio. La iluminación indirecta completa el ambiente y crea una atmósfera acogedora y muy bien resuelta, incluso en pocos metros cuadrados."
        },
        ano: "2026",
        cidade: "Praia dos Carneiros",
        tipo: "residencial",
        outrasFotos: [
            "assets/images/projects/studio-no-mar/images/1.webp",
            "assets/images/projects/studio-no-mar/images/2.webp",
            "assets/images/projects/studio-no-mar/images/3.webp",
            "assets/images/projects/studio-no-mar/images/4.webp",
            "assets/images/projects/studio-no-mar/images/5.webp",
            "assets/images/projects/studio-no-mar/images/6.webp",
        ],
    },
    {
        id: 1,
    ...
    {
        id: 13,
        cover: "assets/images/projects/quarto-toca/quarto-toca-cover.webp",
        titulo: "quarto toca",
        descricao: {
            pt: "O \"quarto toca\" é um ambiente montessoriano acolhedor, com tons terrosos e teto verde que remetem à natureza. A cama no piso em formato de casinha estimula autonomia e imaginação, enquanto os brinquedos acessíveis incentivam a exploração. A raposa surge como elemento especial, fazendo referência ao cachorrinho da família, um shiba, trazendo ainda mais afeto ao espaço.",
            en: "\"Quarto Toca\" is a cozy Montessori-inspired bedroom, with earthy tones and a green ceiling that echo the natural world. The house-shaped floor bed encourages independence and imagination, while easy-to-reach toys invite exploration. The fox appears as a special detail, inspired by the family's little dog, a shiba, bringing even more warmth and affection to the space.",
            es: "El \"quarto toca\" es un ambiente montessoriano acogedor, con tonos terrosos y un techo verde que evocan la naturaleza. La cama a ras del suelo, con forma de casita, estimula la autonomía y la imaginación, mientras que los juguetes al alcance fomentan la exploración. El zorro aparece como un detalle especial, en referencia al perrito de la familia, un shiba, aportando aún más cariño al espacio."
        },
        ano: "2026",
        cidade: "Recife",
        tipo: "residencial",
        outrasFotos: [
            "assets/images/projects/quarto-toca/images/1.webp",
            "assets/images/projects/quarto-toca/images/2.webp",
            "assets/images/projects/quarto-toca/images/3.webp",
            "assets/images/projects/quarto-toca/images/4.webp",
            "assets/images/projects/quarto-toca/images/5.webp",
        ],
    },
    {
        id: 8,
