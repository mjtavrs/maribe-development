...
<footer>
    <div id="socialLinks">
        <ul>
            <li>
                <a href="https://www.instagram.com/maribe.arquitetura" target="_blank"
                    aria-label="Acesse nosso Instagram">
                    <i title="Acesse nosso Instagram" class="ph-light ph-instagram-logo"></i>
                </a>
            </li>
            <li>
                <a href="https://web.facebook.com/people/Maribe-Arquitetura/100089975852864/" target="_blank"
            ...
            <li>
                <a href="https://br.pinterest.com/maribearquitetura/" target="_blank"
                    aria-label="Acesse nosso Pinterest">
                    <i title="Acesse nosso Pinterest" class="ph-light ph-pinterest-logo"></i>
                </a>
            </li>
            <li>
                <a href="https://www.linkedin.com/company/maribearquitetura/" target="_blank"
                    aria-label="Acesse nosso Linkedin">
                    <i title="Acesse nosso Linkedin" class="ph-light ph-linkedin-logo"></i>
                </a>
            </li>
        </ul>
    </div>
